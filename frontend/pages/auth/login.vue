<template>
  ...
  >
    <svg
      class="topography-shape js-shape absolute top-0 right-0 z-10"
      width="1200px"
      height="580px"
      ...
      <form @submit.prevent="submit" class="mt-8" action="#" method="POST">
        ...
        <div>
          <div class="mb-3">
            ...
            />
            <div v-if="errors.username" class="mb-4 mt-2 text-xs text-red-400">
              {{ errors.username[0] }}
            </div>
          </div>
          <div>
            ...
            />
            <div v-if="errors.password" class="mb-4 mt-2 text-xs text-red-400">
              {{ errors.password[0] }}
            </div>
          </div>
        </div>
