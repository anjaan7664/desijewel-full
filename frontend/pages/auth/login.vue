<template>
    ...
    <svg class="absolute top-0 right-0 z-10 topography-shape js-shape" width="1200px" height="580px" viewBox="0 0 1200 580" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-6 z-50">
        ...
        <div>
            <div class="mb-3">
                <input aria-label="Username" name="username" type="username" v-model="form.username" class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 sm:text-sm sm:leading-5" placeholder="Username" />
                <div v-if="errors.username" class="text-red-400 text-xs mb-4 mt-2">{{ errors.username[0] }}</div>
            </div>
            <div>
