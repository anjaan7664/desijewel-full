<template>
  <div id="app" class>
    <div style="padding: 10px;margin: 0px" class="row">
      ...
      <p>
        Desijewel.in is a community supported web site with the majority of the published content being send by our user community or collected from a wide range of resources including free images or wallpapers websites. Published content is believed to be authorized for sharing and personal use . If you object to a photo or image published on our site, please
        <b>
          <a href="/contact_us.php" title="Contact us">Contact us</a>
        </b> with the image's title or URL and your cause for concern, whether it being your own image you've captured and do not wish to share or may it be something you might find explicit, unethical, inappropriate etc. Desijewel.in reserves the right to decide to host or not any image that was submitted or send by users . Desijewel.in will add the Desijewel.in watermark on the images/photos to identify that Desijewel.in is hosting that image/photo.
      </p>
